...
export const LOOKUPS: LookupDef[] = [
  ...
  { kind: "brand", label: "Μάρκα", plural: "Μάρκες", description: "Κατασκευαστές (MTRMANFCTR) — στο SoftOne της Euronics αυτή είναι η «μάρκα» του είδους· το MTRMARK είναι εμπορική σήμανση (Premium, QLED…).", model: "brand", table: "MTRMANFCTR", fields: ["MTRMANFCTR", "CODE", "NAME", "ISACTIVE"],
    ...
    editable: [{ key: "slug", label: "Slug", type: "text", width: "half" }, { key: "domain", label: "Domain μάρκας", type: "text", width: "half", help: "π.χ. samsung.com — από εδώ βγαίνει το λογότυπο μέσω Brandfetch (hotlink· οι όροι τους δεν επιτρέπουν αποθήκευση του αρχείου)." }, { key: "logo", label: "Δικό μας λογότυπο (SVG ή εικόνα)", type: "media", width: "full", help: "Ανέβασε το επίσημο vector από τον κατασκευαστή· υπερισχύει του Brandfetch και φιλοξενείται στο Bunny CDN." }, { key: "featured", label: "Προβεβλημένη", type: "boolean", width: "half" }, { key: "sort", label: "Σειρά", type: "number", width: "half" }], columns: ["logoCdn", "domain", "domainSuggest", "featured"] },
