...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      yesNo("voiceEnabled", "Φωνή στον Άρη (δοκιμαστικό)", "Μικρόφωνο (speech-to-text) και εκφώνηση απαντήσεων (text-to-speech) μέσω OpenRouter, με cache έτοιμου ήχου.", true),
      ...
      { key: "voiceName", label: "Φωνή του Άρη", type: "select", options: [{ value: "ash", label: "Ash (αρσενική, ζεστή)" }, { value: "echo", label: "Echo (αρσενική, καθαρή)" }, { value: "verse", label: "Verse (αρσενική, νεανική)" }, { value: "ballad", label: "Ballad (αρσενική, ήρεμη)" }, { value: "sage", label: "Sage (ουδέτερη)" }, { value: "alloy", label: "Alloy (ουδέτερη)" }, { value: "nova", label: "Nova (θηλυκή)" }, { value: "shimmer", label: "Shimmer (θηλυκή)" }, { value: "coral", label: "Coral (θηλυκή)" }], width: "half" },
      { key: "voiceStyle", label: "Ύφος εκφώνησης", type: "text", placeholder: "Χαρούμενος, ζωηρός τόνος με χαμόγελο· γρήγορος ρυθμός ομιλίας, χωρίς παύσεις.", help: "Οδηγία τόνου/ρυθμού προς το μοντέλο. Αλλαγή = «Αναδημιουργία όλων» στο audio cache.", width: "half" },
      { key: "voiceRate", label: "Ταχύτητα αναπαραγωγής", type: "number", placeholder: "1.1", public: true, help: "Πολλαπλασιαστής στον browser (1 = κανονική, 1.1 = 10% πιο γρήγορα, με διατήρηση τονικότητας).", width: "half" },
