...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "voiceRate", label: "Ταχύτητα αναπαραγωγής", type: "number", placeholder: "1.3", public: true, help: "Πολλαπλασιαστής στον browser (1 = κανονική, 1.3 = 30% πιο γρήγορα, με διατήρηση τονικότητας, έως 2).", width: "half" },
