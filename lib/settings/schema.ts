...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "elevenModel", label: "ElevenLabs · Μοντέλο", type: "select", options: [{ value: "eleven_flash_v2_5", label: "Flash v2.5 — ελάχιστη καθυστέρηση (προτείνεται)" }, { value: "eleven_turbo_v2_5", label: "Turbo v2.5 — ισορροπία" }, { value: "eleven_multilingual_v2", label: "Multilingual v2 — ποιότητα, πιο αργό" }, { value: "eleven_v3", label: "v3 — πιο εκφραστικό" }], width: "half" },
