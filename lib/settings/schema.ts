...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "voiceProvider", label: "Πάροχος φωνής", type: "select", options: [{ value: "openrouter", label: "OpenRouter — μοντέλο με audio (gpt-audio)" }, { value: "elevenlabs", label: "ElevenLabs — καθαρό TTS" }], help: "Για σύγκριση των δύο. Το ElevenLabs θέλει ELEVENLABS_API_KEY στο περιβάλλον του server (.env / Coolify)· χωρίς αυτό μένει το OpenRouter. Κάθε πάροχος έχει δική του cache ήχου. Η απομαγνητοφώνηση (μικρόφωνο) μένει στο OpenRouter.", width: "half" },
      { key: "elevenVoiceId", label: "ElevenLabs · Voice ID", type: "text", placeholder: "JBFqnCBsd6RMkjVDRZzb", help: "Από τη βιβλιοθήκη φωνών του ElevenLabs (My Voices → ID). Προεπιλογή: George, ώριμη ζεστή ανδρική. Το κουμπί «Δοκιμή» δείχνει τις φωνές του λογαριασμού.", width: "half" },
      { key: "elevenModel", label: "ElevenLabs · Μοντέλο", type: "select", options: [{ value: "eleven_v3", label: "v3 — το πιο εκφραστικό, με audio tags, διαβάζει σωστά ξένους όρους (προτείνεται)" }, { value: "eleven_multilingual_v2", label: "Multilingual v2 — ποιότητα, χωρίς tags" }, { value: "eleven_flash_v2_5", label: "Flash v2.5 — ελάχιστη καθυστέρηση, πιο «επίπεδο»" }, { value: "eleven_turbo_v2_5", label: "Turbo v2.5 — ισορροπία" }], help: "Πρώτος ήχος: v3 ≈ 0,9 s, Flash ≈ 0,5 s. Η ροή ξεκινά πριν τελειώσει η σύνθεση.", width: "half" },
      { key: "elevenTags", label: "ElevenLabs · Audio tags (μόνο v3)", type: "text", placeholder: "[calm][serious]", help: "Χρωματίζουν την εκφώνηση: [calm], [serious], [warm], [cheerful], [confident], [whispers]… Μπαίνουν μπροστά από κάθε απάντηση. Αλλαγή = νέα cache ήχου.", width: "half" },
      { key: "elevenSpeed", label: "ElevenLabs · Ταχύτητα (0.7–1.2)", type: "number", placeholder: "1.05", width: "half" },
      { key: "elevenStability", label: "ElevenLabs · Σταθερότητα (0–1)", type: "number", placeholder: "0.5", help: "Ψηλά = πιο σταθερή, σοβαρή εκφώνηση· χαμηλά = πιο εκφραστική.", width: "half" },
      { key: "elevenSimilarity", label: "ElevenLabs · Πιστότητα φωνής (0–1)", type: "number", placeholder: "0.8", width: "half" },
      { key: "elevenUsdPer1kChars", label: "ElevenLabs · Κόστος ανά 1.000 χαρακτήρες ($)", type: "number", placeholder: "0.1", help: "Εκτίμηση για τις αναφορές κόστους (το ElevenLabs χρεώνει credits ανά χαρακτήρα, ανάλογα με το πλάνο).", width: "half" },
      { key: "voiceTtsModel", label: "Μοντέλο εκφώνησης (OpenRouter)", type: "text", placeholder: "openai/gpt-audio-mini", help: "Chat μοντέλο με audio output (streaming pcm16). Χρέωση ανά audio token.", width: "half" },
