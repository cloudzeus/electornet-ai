...
export interface Replacement { id: string; slug: string; brand: string; title: string; price: number; wasPrice?: number; image: string | null; energy: string | null; kwh: number | null; savingEur: number | null; dims: { w: number; h: number; d: number } | null; fit: { ok: boolean; note: string } | null; href: string; why: string }
export interface SnapResult { scanId: string; appliance: ApplianceId; matched: { id: string; slug: string; brand: string; title: string; price: number; image: string | null } | null; replacements: Replacement[]; oldKwh: number | null; kwhPrice: number; categoryHref: string | null; aiAvailable: boolean }
